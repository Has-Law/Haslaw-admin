...
const LawyersApplicantProfilePage = () => {
    ...
    return (
        <div className='p-4'>
            <div className="p-4 bg-white rounded-2xl shadow-lg min-h-screen">
                <div className="flex flex-col gap-8 p-4">
                    <Link href={`/careers/lawyers/details/${batchId}/applicants`} className="flex items-center gap-2 text-[#4F000D] hover:text-[#A0001B] font_britanica_bold cursor-pointer w-fit">
...
export default LawyersApplicantProfilePage;