...
const StaffApplicantsListPage = () => {
    ...
    if (loading) return <div className="p-8 text-center">Memuat daftar pelamar...</div>;
                                ...
                                applicants.map((applicant, index) => (
                                    <div key={applicant.id} className="flex items-center text-base">
                                        ...
                                        <div className="px-6 py-2 bg-[#F5F5F5] rounded-r-xl w-34 sm:w-32 flex-shrink-0 justify-center flex gap-2 ">
                                            ...
                                            <Link href={`/careers/staff/details/${batchId}/applicants/${applicant.id}`}>
...
export default StaffApplicantsListPage;