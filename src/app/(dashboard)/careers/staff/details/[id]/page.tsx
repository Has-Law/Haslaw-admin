...
const StaffDetailsPage = () => {
    ...
    if (isLoading) return <div className="p-8 text-center font_britanica_bold text-xl">Loading Details...</div>;
    ...
    return (
        <>
            ...
            <FieldModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSubmit={handleFormSubmit} initialData={editingField} />
        </>
    );
};
