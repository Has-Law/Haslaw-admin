...
import { createMember, CreateMemberData, validateMemberData } from '@/lib/members';
...
const AddMember = () => {
    ...
    const positions = [ "Senior Partner", "Partner","Senior Associate", "Associates","Mid Associate","of Counsel"];
    ...
    const handleImageUpload = (
        ...
        if (file) {
            ...
            if (!allowedTypes.includes(file.type)) {
                showNotification('Format gambar harus JPEG, PNG, atau WebP.', 'error');
                return;
            }
    ...
    const handleAddMember = async () => {
        ...
        try {
            ...
            let errorMessage = 'Gagal menambahkan member.';
